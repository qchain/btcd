...
|--rpclisten=:8445|all interfaces on port 8445|
|--rpclisten=0.0.0.0:8445|all IPv4 interfaces on port 8445|
|--rpclisten=[::]:8445|all IPv6 interfaces on port 8445|
|--rpclisten=127.0.0.1:8445|only IPv4 localhost on port 8445|
|--rpclisten=[::1]:8445|only IPv6 localhost on port 8445|
...
|--rpclisten=127.0.0.1:8337 --listen=[::1]:8445|IPv4 localhost on port 8337 and IPv6 localhost on port 8445|
|--rpclisten=:8445 --listen=:8337|all interfaces on ports 8445 and 8337|
