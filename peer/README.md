...
(http://godoc.org/github.com/qchain/btcd/peer)
...
```bash
$ go get -u github.com/qchain/btcd/peer
```

## Examples

* [New Outbound Peer Example]
  (https://godoc.org/github.com/qchain/btcd/peer#example-package--NewOutboundPeer)  
